...
- rebuilt Home status cards and instruction panels to reflow;
- removed encrypted-workspace cloning from the paint path;
- routed background completion through the Windows message queue;
