...
- Issue #20 permits source-linked assistance with health, legal and other sensitive evidence in principle, but current Ask ECO and future model routes are not approved for real or sensitive evidence until they prove source attribution, output-status separation, meaningful review and the absence of diagnosis, treatment, clinical-risk, professional-representation, profiling, scoring and authority-side adverse-decision outputs.
...
- The intended-purpose and public-claims control is recorded in `docs/governance/INTENDED_PURPOSE_AND_CLAIMS_CONTROL.md`; issue #16 remains open until the merged record and cross-surface implementation/conformance evidence are independently verified. Retired PR #18 is not controlling.
